...
DJANGODIR=/eathis/server                  # Django project directory
WSGI_MODULE=eathis.wsgi:application    # Django WSGI module
DJANGO_SETTINGS_MODULE=eathis.settings # Django settings
